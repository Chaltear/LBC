...
<html lang="fr">
<head>
    <title>Nouvelle annonce - Le coin Japon</title>
                            ...
                            <div class="card-body">
                                ...
                                <form enctype="multipart/form-data" action="" method="post"> <!--Formulaire d'ajout d'annonce-->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" step="0.01" name="prix" class="form-control form-control-lg" placeholder="Entrez le prix:" />
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" accept='.png, .jpg, .jpeg' class="form-control" name="photo" />
                                    </div>
                                    <div class="mb-4">
                                        <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked/>
                                        <label class="form-check-label" for="flexCheckChecked">J'accepte les conditions général d'utilisateur, les règles de diffusion du site Le coin Japon et j'autorise Le coin Japon a diffuser mon annonce.
                                        </label>
                                    </div>
                                    <input style="color : #ffffff; background-color: #800000;" class="btn px-5" name="btn" type="submit" value="Enregistrer">
                                </form>

...
$timeAnnonce = $req["time"];
  ...
  //dans le cas où aucun utilisateur n'est connecté on ajoute automatiquement une vue
...
<html lang="fr">
<head>
    <title>Detail annonce - Le coin Japon</title>
                            ...
                            <div class="card-body">
                                <div class='card rounded hover-shadow'>
                                    ...
                                    if(isset($uid)){
                                        ...
                                        if($verif->rowCount() == 0){
                                            echo '<i style="color: #800000 class="fa-regular fa-heart"></i>';
                                        }else{
                                            echo '<i style="color: #800000" class="fa-solid fa-heart"></i>';
                                        }
                                    }else{  ?>
                                        <i style="color: #800000" class="fa-regular fa-heart"></i>
                                    <?php } ?>
                                                <?=$favoris?></a></span>
                                    </div>
                    ...
                    <div class="col-lg-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <div class='card rounded hover-shadow'>
                                    <div class="card">
                                        <h2><?=$titre?><p class="float-end h3"><?= number_format($prix, 2, ',', ' ')  ?> €</p></h2>
                                        <ul class="product-variation">
                                            ...
                                            <?php elseif ($categorie==2): ?>
                                                <a class="badge badge-pill badge-warning" href="categorie.php?idcategorie=<?=$categorie?>">Thriller/Policier<i class="fa-solid fa-user-secret mx-2"></i></a>
                                            <?php elseif ($categorie==3): ?>
                                                <a class="badge badge-pill badge-info" href="categorie.php?idcategorie=<?=$categorie?>">Science Fiction<i class="fa-solid fa-rocket mx-2"></i></a>
                                            <?php elseif ($categorie==4): ?>
                                                <a class="badge badge-pill badge-danger" href="categorie.php?idcategorie=<?=$categorie?>">Art, Culture & Société<i class="fa-solid fa-feather-pointed mx-2"></i></a>
                                            <?php elseif ($categorie==5): ?>
                                                <a class="badge badge-pill badge-danger" href="categorie.php?idcategorie=<?=$categorie?>">Fantasy<i class="fa-solid fa-feather-pointed mx-2"></i></a>
                                            <?php else: ?>
                                                <a class="badge badge-pill badge-success" href="categorie.php?idcategorie=<?=$categorie?>">Manga<i class="fa-solid fa-earth-europe mx-2"></i></a>
                                            <?php endif; ?>

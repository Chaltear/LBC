...
<head>
    ...
    <link rel="shortcut icon" href="../image/japanflagmini.ico" />
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="auth-form-transparent text-left p-3">
                        <div class="brand-logo text-center">
                            <img src="../image/japanflag.jpg" alt="logo">
                        </div>
                        <h4>Nouveau ici ?</h4>
                        ...
                        <div class="pt-3 table-responsive">
                            <form class="" action="" method="post" style="height: 500px"> <!-- formulaire d'inscription-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-danger">Veuillez entrer au moins 10 caractères.</small>
                                    </div>
                                    <div class="form-group">

...
<html lang="fr">
<head>
    <title>Accueil - Le coin Japon</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a class="btn btn-warning" style="background-color: #800000" href="<?php if(isset($uid)): ?>nvAnnonces.php <?php else: ?> /jalegreatdeal/View/connexion.php <?php endif; ?>">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p class="product-price"><?= number_format($tableau["prix"], 2, ',', ' ')  ?> €</p>
                                                ...
                                                <ul class="product-variation">
                                                        ...
                                                        <span class="badge badge-danger">Art Culture & Société <i class="fa-solid fa-feather-pointed mx-2"></i></span>
                                                        <?php elseif ($tableau["categorie"]==5): ?>
                                                        <span class="badge badge-danger">Fantasy <i class="fa-solid fa-feather-pointed mx-2"></i></span>
                                                        <?php else: ?>
                                                        <span class="badge badge-success">Manga <i class="fa-solid fa-earth-europe mx-2"></i></span>
                                                        <?php endif; ?>
                                                </ul>
                                ...
                                <div class="row portfolio-grid mt-3">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <figure class="effect-text-in">
                                            <img src="../image/equipe/trenton.jpg" style="height: 365px" alt="image" />
                                            <figcaption>
                                                <h4 class="text-dark">Trenton</h4>
                                                <p style="background-color: #800000">soutien moral<br>alternant <br>
                                                    trentonchat@miaou.fr</p>
                                            </figcaption>
                                        </figure>
                                    </div>
